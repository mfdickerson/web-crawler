...
async def test_update_to_visit(client_session):
    ...
    crawler.visited = set(['https://www.web-crawlers.com' , 'https://www.web-crawlers.com/peter-parker'])
    ...
    assert crawler.to_visit == set(['https://www.web-crawlers.com/peni-parker', 'https://www.web-crawlers.com/miguel-ohara'])